...
const MidMenubar = () => {
  return (
    <div className="mt-[8] flex h-[45px] w-[259px] items-center justify-between">
      <div className="text-nav2-sm flex flex-col items-center justify-center text-white">
        <Image src={AddBtn} alt="add my list" />
        <p>My List</p>
      </div>
      <div className="bg-gray-0 text-title1-sb flex h-[45px] w-[110px] items-center justify-between rounded-[5px] text-black hover:bg-white">
